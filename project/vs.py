...
if __name__ == '__main__':
    ...
    if len(sys.argv) >= 5:
        ...
        l2_path = sys.argv[3]
        r2_path = sys.argv[4]
        n = int(int(sys.argv[5]) / 1000)
        g1 = sys.argv[6]
        g2 = sys.argv[7]
        print(n)
        print(g1)
        # 在这里可以使用传递的四个参数进行后续的处理逻辑
        # 示例：打印四个文件路径
        print('Left 1 Path:', l1_path)
        print('Right 1 Path:', r1_path)
        print('Left 2 Path:', l2_path)
        print('Right 2 Path:', r2_path)
    # l1_path = "D:\\1study\大学\大三上\软件课设\软件课设v2\group\【666】\HoneyBee.java"
    # r1_path = "D:\\1study\大学\大三上\软件课设\软件课设v2\group\【666】\HoneyBee.java"
    # l2_path = "D:\\1study\大学\大三上\软件课设\软件课设v2\group\【666】\Hornet.java"
    # r2_path = "D:\\1study\大学\大三上\软件课设\软件课设v2\group\【666】\Hornet.java"
    # n = 1
    # BF,Group目录路径
    BFSource = ["D:\code\software_project\Group_project-main\BF1", "D:\code\software_project\Group_project-main\BF2"]
    ...
    # current_file_path = []
    GHoneyBee = [l1_path, r1_path]
    GHornet = [r2_path, l2_path]
    ...
    visualization(result1, counts1, result2, counts2, g1, g2)
